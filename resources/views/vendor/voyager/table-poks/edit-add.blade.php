            ...
            <div class="col-md-12">
               <div class="col-md-4">
                   <div class="form-group" id="pd">
                       <label class="control-label">RKO Kegiatan</label>
               ...
               <div class="col-md-12" >
                   <div class="form-group"><label>Sub Kegiatan</label>
                       <div class="row" id="input-player-list">
                           <div class="col-md-4">
                               <input placeholder="Nama Kegiatan" name="nama_sub_keg[]" id="nama_sub_keg" class="form-control"
                                      required>
                           </div>
                           <div class="col-md-4">
